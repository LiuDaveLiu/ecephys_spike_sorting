...
run_specs = [									
					#['dl56', '20181125', '0', 'start,end', ['ww2'], ['SY'], ['cortex'] ]
                    ['dl62', '20190128', '0', 'start,end', ['ww2'], ['SY'], ['cortex'] ]                    
...
catGT_dest_parent = r'A:\kilosort_datatemp'
...
catGT_cmd_string = '-prb_3A -no_run_fld -t_miss_ok -gblcar -apfilter=butter,16,250,0 -gfix=0,0.10,0.02'
#catGT_cmd_string = '-prb_3A -no_run_fld -t_miss_ok -gblcar -apfilter=biquad,2,300,9000 -gfix=0,0.10,0.02'
